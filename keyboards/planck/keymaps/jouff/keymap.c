// This is the Jouff's layout file for the Quantum project.
...
[_QWERTY] = {
  ...
  {KC_FN0, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
